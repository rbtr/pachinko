...
func (c *Client) identify(m types.Media) (api.MovieDetails, error) {
...
func (c *Client) addTMDbMetadata(m types.Media) types.Media {
...
func init() {
	processor.Register("tmdb", func() processor.Processor {
		return &Client{}
	})
}
